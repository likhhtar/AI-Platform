...
class LlmPromptOptimizer(
    ...
    /**
     * Enforce keeping the same logical prompt identity as the YAML prompt id for fair comparative runs.
     */
    ...
    /**
     * Retries only for timeouts, rate limits, and 5xx-style transport failures — not for validation or JSON shape errors.
     */
