...
object TestConfigurationYamlEmitter {
    ...
    /** Multiline literals or compact quoted scalar. */
    ...
    /**
     * Prefer block style when the string has many quotes or backslashes to avoid fragile escaping,
     * or when it could be misread as YAML structure in double-quoted flow.
     */
